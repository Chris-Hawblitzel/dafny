...
ref Attributes readsAttrs, ref Attributes modAttrs, ref Attributes decrAttrs) {
		...
		while (!(StartOf(17))) {SynErr(183); Get();}
		if (la.kind == 48) {
			Get();
			while (IsAttribute()) {
...
List<Expression> decreases, ref Attributes decAttrs, ref Attributes modAttrs, string caption) {
		...
		while (!(StartOf(20))) {SynErr(186); Get();}
		if (la.kind == 47) {
			Get();
			while (IsAttribute()) {
				Attribute(ref modAttrs);
	...
	void CaseStatement(out MatchCaseStmt/*!*/ c) {
		...
		Expect(31);
		while (!(StartOf(32))) {SynErr(231); Get();}
		while (IsNotEndOfCase()) {
			Stmt(body);
			while (!(StartOf(32))) {SynErr(232); Get();}
		}
  ...
  static readonly bool[,] set = {
		...
		{_x,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x},
